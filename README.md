...
- `SMS_SelectionProcess_Submitted.xlsx` — Selection workflow and the final list of included studies.
- `SMS_DataExtraction_Submitted.xlsx` — Data extraction table with raw extracted data used in the synthesis.
- `SMS_ExternalMaterial.pdf` — External material for the SMS, providing the information needed for reproducibility and auditability (e.g., protocol details and string configuration).
